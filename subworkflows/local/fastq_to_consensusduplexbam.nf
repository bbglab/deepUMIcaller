...
include { FGBIO_CALLDUPLEXONSENSUSREADS     as CALLUMICONSENSUS } from '../modules/nf-core/fgbio/callduplexconsensusreads/main.nf'
...
workflow FASTQ_CREATE_UMI_CONSENSUS_FGBIO {
    ...
    groupreadsbyumi_strategy  // string:  [mandatory] grouping strategy - default: "Paired"
