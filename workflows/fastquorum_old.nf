...
include { ALIGN_BAM                         as ALIGN_RAW_BAM               } from '../modules/local/align_bam_mod/main'
include { ALIGN_BAM                         as ALIGN_CONSENSUS_BAM         } from '../modules/local/align_bam_mod/main'
...
workflow FASTQUORUM {
    ...
    if (params.duplex_seq) {
        ...
        //
        CALLDUPLEXCONSENSUSREADS(GROUPREADSBYUMI.out.bam, call_min_reads, params.call_min_baseq)
        ...
        CALLDUPLEXCONSENSUSREADS.out.bam.set { ch_consensus_bam }
    } else {
        //
